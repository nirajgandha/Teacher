...
public class FemaleStudentItem{
	...
	@SerializedName("student_sessions_id")
	private String studentSessionsId;
	...
	@SerializedName("attendence_type_id_of")
	private int attendenceTypeIdOf;
	...
	@SerializedName("attendence_type_remark")
	private String attendenceTypeRemark;
	...
	public String getStudentSessionsId(){
		return studentSessionsId;
	}
	...
	public int getAttendenceTypeIdOf(){
		return attendenceTypeIdOf;
	}
	...
	public String getAttendenceTypeRemark(){
		return attendenceTypeRemark;
	}
	...
	@Override
 	public String toString(){
		return 
			...
			",roll_no = '" + rollNo + '\'' + 
			",student_sessions_id = '" + studentSessionsId + '\'' + 
			",udid = '" + udid + '\'' + 
			",email = '" + email + '\'' + 
			",attendence_type_id_of = '" + attendenceTypeIdOf + '\'' + 
			",rte = '" + rte + '\'' + 
			",father_occupation = '" + fatherOccupation + '\'' + 
			",guardian_occupation = '" + guardianOccupation + '\'' + 
			",is_active = '" + isActive + '\'' + 
			",attendence_type_remark = '" + attendenceTypeRemark + '\'' + 
